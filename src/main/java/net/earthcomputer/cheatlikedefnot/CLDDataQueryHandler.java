...
public class CLDDataQueryHandler {
    ...
    public CLDDataQueryHandler(ClientPlayNetworkHandler networkHandler) {
        this.networkHandler = networkHandler;
    }

    public static CLDDataQueryHandler get(ClientPlayNetworkHandler networkHandler) {
        return ((IClientPlayNetworkHandler) networkHandler).cheatlikedefnot_getCLDDataQueryHandler();
    }
